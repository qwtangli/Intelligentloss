...
+function ($) {
    ...
    $.alertSelfDefine = function (text, title, buttonText,callbackOk) {
        if (typeof title === 'function') {
            callbackOk = arguments[1];
            title = undefined;
        }
        if(!buttonText){
          buttonText = defaults.modalButtonOk;
        }
        
        return $.modal({
            text: text || '',
            title: typeof title === 'undefined' ? defaults.modalTitle : title,
            buttons: [ {text: buttonText, bold: true, onClick: callbackOk} ]
        });
    };
    ...
    $.showIndicator = function () {
        ...
        $(defaults.modalContainer).append('<div class="preloader-indicator-modal"><div class="loader"></div></div>');
    };
    ...
    var Picker = function (params) {
        ...
        var defaults = {
            ...
            toolbarTemplate: '<header class="bar bar-nav">\
                <button type="button" class="button button-link pull-right close-picker">确定</button>\
